...
<div id="post1">
	...
	<p>
		<span class="">Choose a building:</span> 
		
		<select id="building-info" name="building-info" class="dropdown">
		...
		<input id="change-building" type="submit" />
...
<script type="text/javascript" src="data/javascript/buildings.js"></script>
<br class="clearfix" />
